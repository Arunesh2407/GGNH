...
interface ImportMetaEnv {
  ...
  readonly VITE_ATTENDANCE_EDITOR_EMAILS?: string;
  ...
  readonly VITE_FIREBASE_DELETE_USER_FUNCTION_NAME?: string;
  ...
  readonly VITE_APPWRITE_USER_ACCESS_COLLECTION_ID?: string;
}
