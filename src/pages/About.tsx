...
import { Bed, Shield, Clock, Users, Target, Heart, ArrowRight, Award, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
            ...
            <ScrollReveal>
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl overflow-hidden shadow-[var(--card-shadow-hover)]">
                  <img src="https://www.ggnursinghome.com/assets/images/hospital-1.jpg" alt="G G Nursing Home Building" className="w-full h-52 object-cover" loading="lazy" />
                </div>
                <div className="rounded-xl overflow-hidden shadow-[var(--card-shadow-hover)] mt-8">
                  <img src="https://www.ggnursinghome.com/assets/images/hospital-2.jpg" alt="G G Nursing Home" className="w-full h-52 object-cover" loading="lazy" />
                </div>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={150}>
              <span className="text-sm font-semibold text-primary tracking-wide uppercase">Who We Are</span>
              <h2 className="heading-display text-3xl font-bold text-foreground mt-2 mb-4">
                Serving Katni with <span className="text-accent">Compassionate Care</span>
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                G G Nursing Home (Unit of G G Nursing Home Pvt. Ltd) is situated at Madan Mohan Choubey Ward, Bargawan, Katni (M.P) and has been authorized the Allopathy system of medicine. G.G. Nursing Home is NABH Pre-accredited and a 50 Bedded hospital (including 6 Bedded ICU, Private Deluxe wards and general wards with all facilities).
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Departments include Orthopaedics, Ophthalmology, General Medicine, General Surgery, Pathology, Physiotherapy and Radiology. The hospital has been providing services for the last 20 years.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Registered for NPCBVI (National Programme For Control Of Blindness & Visual Impairment), Ayushman Bharat – Jan Arogya Yojna (AB-PMJAY), Employees' State Insurance Corporation (ESIC), Railway Hospital, and many TPA companies.
              </p>
              <div className="flex flex-wrap gap-3">
                {["NABH Pre-accredited", "Ayushman Bharat", "ESIC", "Railway Hospital"].map((tag) => (
      ...
      <section className="section-padding bg-muted/30">
        <div className="container mx-auto px-4">
          <SectionHeading label="Infrastructure" title={<>World-Class <span className="text-accent">Facilities</span></>} />
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { icon: Bed, title: "50 Beds", desc: "General, Deluxe & ICU wards" },
              { icon: Shield, title: "6 Bed ICU", desc: "Advanced monitoring equipment" },
              { icon: Clock, title: "24×7 Emergency", desc: "Round-the-clock trauma care" },
              { icon: Users, title: "Modern OT", desc: "Fully equipped operation theatres" },
            ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollReveal>
              <div className="bg-card rounded-xl p-8 shadow-[var(--card-shadow)] hover:shadow-[var(--card-shadow-hover)] transition-shadow h-full border-t-4 border-primary">
                ...
                <h3 className="heading-display text-2xl font-bold text-foreground mb-4">Our Mission</h3>
            ...
            <ScrollReveal delay={100}>
              <div className="bg-card rounded-xl p-8 shadow-[var(--card-shadow)] hover:shadow-[var(--card-shadow-hover)] transition-shadow h-full border-t-4 border-accent">
                ...
                <h3 className="heading-display text-2xl font-bold text-foreground mb-4">Vision & Values</h3>
      ...
      <section className="section-padding-sm" style={{ background: "var(--hero-gradient)" }}>
        <div className="container mx-auto px-4 text-center text-white">
          <ScrollReveal>
            <h2 className="heading-display text-2xl md:text-3xl font-bold mb-4">Need a Consultation?</h2>
            <Link to="/contact">
